...
vertices1 = np.array([(209, 534), (412, 301), (457, 311), (430, 531)], dtype=np.int32)       
vertices2 = np.array([(527, 537), (492, 310), (530, 304), (707, 533)], dtype=np.int32)       
...
text_position_right_lane = (500, 50)
intensity_position_left_lane = (10, 100)
intensity_position_right_lane = (500, 100)
...
while cap.isOpened():
    ...
    if ret:
        ...
        # Copy original frame for inference
